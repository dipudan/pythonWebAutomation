...
class HomePage:
    lbl_4th_sku_name = (By.XPATH, '//div[contains(text(),"Sauce Labs Onesi")]')
    ...
    def verify_success_login(self, driver: webdriver):
        try:
            lbl_assetHomePage = (WebDriverWait(driver, TestConstant.wait_time.value)
                                 .until(EC.presence_of_element_located(self.lbl_4th_sku_name)))
